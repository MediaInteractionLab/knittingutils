...
var KnitoutWrapper = function() {
     ...
     * 
     * @param {*} c carrier object
     * @param {Number} l needle number for leftmost bringin loop (optional)
     * @param {Number} r needle number for rightmost bringin loop (optional)
    ...
    this.bringIn = function(c, stitchNumber, l, r) {
        ...
        if(l !== undefined && r !== undefined) {
            ...
            console.warn("WARNING: either l or r is undefined in bringIn -- field will not be knit");
        }
