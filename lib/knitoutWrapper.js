...
var KnitoutWrapper = function() {
     ...
     * 
     * @param {*} c carrier object
     * @param {Number} l needle number for leftmost fixation loop (optional)
     * @param {Number} r needle number for rightmost fixation loop (optional)
    ...
    this.bringIn = function(c, stitchNumber, l, r) {
        ...
        if(l !== undefined && r !== undefined) {
            ...
            console.warn("WARNING: either l or r is undefined in bringIn -- fixation will not be knit!");
        }
    ...
    this.castOn = function(c, l, r, stitchNumber = undefined, frontBed = true) {
        ...
        if(l >= r) {
            console.warn("WARNING: left needle index greater than right needle index in castOn (l: " + l + "; r: " + r + "), possible error!");
            return;
        }
