...
var KnitoutWrapper = function(backend) {
     ...
     */
    this.castOn = function(c, l, r, stitchNumber = undefined, beds = ['f'], tube = undefined) {
     ...
     */
    this.castOff = function(c, l, r, stitchNumber = undefined, beds = ['f'], chainLoops = 3, tube = undefined) {

        //TODO: figure out how to cast off a tube!
        ...
        if(tube) {
            ...
            if(c.pos < center) {
                 if(l <= 1)
                     throw Error("castoff not entirely possible -> shift pattern to the right by " + (2 - l) + " needle(s)");                
