...
var KnitSequence = function() {
    ...
    */
     ...
     */
    this.generate = function(outFileName, desc = "", position = "Keep", machine = undefined, halfGauge = false) {
                        ...
                        if(!ci.carrier.isIn) {
                            ...
                            if(!numActiveCarriers) {
                                if(course.ops.length) {
                                    ...
                                    //NOTE: castOn does not really count, wasTuck flag is meant to tell us something else.
                                    //ci.wasTuck = true;
                                    if(dropBringIn) {
                                        kw.dropBringIn();
                                        dropBringIn = null;
